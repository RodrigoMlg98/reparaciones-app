...
export class VaporComponent implements OnInit {
  ...
  clickEvent(){
    ...
    var fuga = "no%20presenta%20olores.%20";
    ...
    if (olor == 1){
      fuga = "si%20presenta%20olores.%20";
    }
    ...
    window.open("https://wa.me/525545508452?text=Me%20gustaría%20contratar%20un%20servicio%20de%20reparación,%20mi%20vapor%20"+enciende+""+fuga+""+descripcion,'_blank');
  }
