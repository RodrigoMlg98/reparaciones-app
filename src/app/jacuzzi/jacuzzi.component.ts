...
@Component({
  selector: 'app-jacuzzi',
  templateUrl: './jacuzzi.component.html',
  styleUrls: ['./jacuzzi.component.css']
})
export class JacuzziComponent implements OnInit {
  ...
  clickEvent(){
    ...
    var bomba = "no%20presenta%20fugas.%20";
    ...
    if (olor == 1){
      bomba = "si%20presenta%20fugas.%20";
    }
    ...
    window.open("https://wa.me/525545508452?text=Me%20gustaría%20contratar%20un%20servicio%20de%20reparación,%20mi%20jacuzzi%20"+enciende+""+bomba+""+descripcion,'_blank');
  }
